...
![image-20210803191537720](G:\技术积累\JVM调优.assets\image-20210803191537720.png)
...
Parallel其实就是多线程的Serial垃圾收集器。目的，提高吞吐量（高效利用CPU）

#### 1.3CMS收集器（运行在老年代）

CMS:Concurrent Mark Sweep , 使用标记清除算法 ，关注用户体验
...
分代年龄设置小，可以让一些顽固对象早点进入老年代，不要在年轻代中反复横跳浪费资源，比如一些缓存对象。

ParaNew+CMS ,比较主流的垃圾收集器
